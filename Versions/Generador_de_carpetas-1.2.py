# creador de carpetas multiples - 1.2 #
...
def guardar_nombres():
    ...
    if not ruta_destino:
        label_output.configure(text="No se seleccionó una ruta de destino.")
        return
    ...
    try:
        for nombre in nombres_guardados:
            ...
            label_output.configure(text="Carpetas creadas en:\n" + ruta_destino)
            ruta_entry.delete(0, tk.END)
            folder_listbox.delete(0, tk.END)
    except OSError as e:
        label_output.configure(text="Error al crear las carpetas.")
...
label_output = tk.Label(window_main, text="", font=font_boton, bg="gray36", fg="ghost white")
label_output.place(x= 45,y=350)
